...
class Jikan4 {
    ...
    async getAnimeSearch({
        ...
        let url = `${this.baseURL}/anime?page=${page}&limit=${limit}&q=${q}&type=${type}&min_score=${minScore}&max_score=${maxScore}&status=${status}&rating=${rating}&sfw=${sfw}&genres=${genres}&genresExclude=${genresExclude}&order_by=${orderBy}&sort=${sort}&producer=${producer}`
    ...
    async getAnimeThemes({
        page = 1, // int
        limit = 1000, // int - 
    } = {}) {
        return this.getAnimeGenres({
            page: page,
            limit: limit,
            filter: "themes"
        });
    ...
    async getMangaThemes({
        page = 1, // int
        limit = 1000, // int - 
    } = {}) {
        return this.getMangaGenres({
            page: page,
            limit: limit,
            filter: "themes"
        });
    ...
    async getMangaSearch({
        ...
        let url = `${this.baseURL}/manga?page=${page}&limit=${limit}&q=${q}&type=${type}&min_score=${minScore}&max_score=${maxScore}&status=${status}&rating=${rating}&sfw=${sfw}&genres=${genres}&genresExclude=${genresExclude}&order_by=${orderBy}&sort=${sort}&magazine=${magazine}`
    ...
    */
    ...
    async get(url) {
        ...
        if (data != null) {
            ...
            console.log("[DEBUG] Jikan4 used cache. Loaded " + url)
