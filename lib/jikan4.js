...
class Jikan4 {
    ...
    async getMangaSearch({
        ...
        let url = `${this.baseURL}/manga?page=${page}&limit=${limit}&q=${q}&min_score=${minScore}&max_score=${maxScore}&sfw=${sfw}&genres=${genres}&genresExclude=${genresExclude}&order_by=${orderBy}&sort=${sort}`;
