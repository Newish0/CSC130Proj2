import { getAuth, createUserWithEmailAndPassword, onAuthStateChanged, signInWithEmailAndPassword, signOut, updateProfile, deleteUser} from "https://www.gstatic.com/firebasejs/9.6.8/firebase-auth.js";
...
$(() => {
    ...
    function initDeleteAccountBtns(user) {
        ...
        $("#comfirm-delete-account").on("click", () => {
            let input = $("#delete-account-input").val();
        ...
        get(dataRef)
            .then((snapshot) => {
                ...
                if (snapshot.exists()) {
                    ...
                    // generate sections
                    watchingListContainer.append(
                        '<h4>Watching</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="wl-watching"></div><br>'
                    );
                    watchingListContainer.append(
                        '<h4>Completed</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="wl-completed"></div><br>'
                    );
                    watchingListContainer.append(
                        '<h4>Considering</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="wl-considering"></div><br>'
                    );
                    watchingListContainer.append(
                        '<h4>On Hold</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="wl-hold"></div><br>'
                    );
                    watchingListContainer.append(
                        '<h4>Dropped</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="wl-dropped"></div><br>'
                    );
        ...
        get(dataRef)
            .then((snapshot) => {
                ...
                if (snapshot.exists()) {
                    ...
                    // generate sections
                    readingListContainer.append(
                        '<h4>Reading</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="rl-watching"></div><br>'
                    );
                    readingListContainer.append(
                        '<h4>Completed</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="rl-completed"></div><br>'
                    );
                    readingListContainer.append(
                        '<h4>Considering</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="rl-considering"></div><br>'
                    );
                    readingListContainer.append(
                        '<h4>On Hold</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="rl-hold"></div><br>'
                    );
                    readingListContainer.append(
                        '<h4>Dropped</h4><div class="auto-gallery justify-start align-items-start margin-v-small" id="rl-dropped"></div><br>'
                    );
