$(() => {
    ...
    function createOneCard(oneData) {
        ...
        let titleHREF = "/CSC130Proj2/anime/?id=" + oneData.mal_id;

        let tagsHTML = "";
        for (let i in oneData.genres) {
            let tag = `
                <a class="tag clean-url" 
                href="/CSC130Proj2/search/anime/?genre=${oneData.genres[i].mal_id}~${encodeURIComponent(oneData.genres[i].name)}">
        ...
        imgLink = "/CSC130Proj2/anime/?id=" + oneData.mal_id;
